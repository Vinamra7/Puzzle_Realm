...
import './login.css'
import logo from '../../assets/images/lx.png'
import logoText from '../../assets/images/loc.png'
            ...
            <div className="login-parent">
                <div className="container upperBox">
                    <div className="container left">
                        <img src={logo} className="gif_left phone giff spinn" alt="logo"></img>
                        <img src={logoText} className="gif_left pull giff2" alt="main_logo"></img>
                        <p className="text mb-4">Challenge yourself with our engaging puzzle and develop your abilities.</p>
                    </div>
